      ...
      <div className="page-content">
          ...
          <div className="content-section">
            ...
            <div>
              <p>
                ...
                addressing common administrative challenges that can distract
                from training and enjoying sports.
              </p>

              <p>
                Streamlining sports team management is achieved by allowing
                coaches to effortlessly track attendance, practice hours, and
                promotions. It also offers user-friendly team calendars to
                enhance communication and coordination. In essence, this app
                streamlines the sports experience, reducing administrative
                hassles and enabling a more focused pursuit of athletic
                excellence for everyone involved.
              </p>
            </div>
          </div>
        ...
        <div className="research-container">
            ...
            <div className="content">
              ...
              <div>
                ...
                <ul>
                  ...
                  <li>
                    Gather insights on how key competitors address customer
                    needs
                  </li>
          ...
          <div className="content-section">
            ...
            <div className="content">
              <div>
                ...
                <p>
                  Market research important to grasp the broader market
                  landscape, including audience, knowledge gaps, recent trends,
                  and news. The insights gained will inform provisional personas
                  and guide meaningful questions for primary research.
                </p>
              </div>
              ...
              <div>
                ...
                <p>
                  ...
                  experienced a consistent increase in demand, driven by the
                  need for streamlined communication, scheduling, and data
                  management for sports teams of all levels
                </p>
              </div>
              ...
              <div>
                ...
                <ul>
                  <li>
                    ...
                    youth and amateur sports teams, such as Little League
                    baseball, local soccer clubs, and school athletics.
                  </li>

                  <li>
                    Sports management platforms are commonly utilized by
                    schools, colleges, and universities to coordinate sports
                    activities, manage teams, and ensure compliance with
                    regulations.
                  </li>
          ...
          <div className="content-section">
            ...
            <div className="content">
              <p>
                ...
                meaningful conversations with our user community, which helped
                me gather direct insights through primary research methods.
              </p>
              ...
              <div>
                ...
                <ul>
                  ...
                  <li>
                    Can you share some challenging experiences you've
                    encountered while overseeing your team?
                  </li>
                  <li>
                  ...
                  <li>
                    Where do you maintain your team's seasonal calendar, and
                    what methods do you employ to keep it up-to-date?
                  </li>
                  <li>
                    How satisfied are you with the team's communication
                    dynamics?
                  </li>
                  <li>
            ...
            <div className="content">
              <div>
                <p>
                  ...
                  Must-have (P1), Nice-to-Have (P2), and Extra (P3) features.
                  The categorization was based on their alignment with both
                  business and user objectives.
                </p>

                <p>
                  The product roadmap not only aligns project goals with the
                  product but also guarantees that we prioritize the most
                  critical features during the development phase.
                </p>
              </div>
          ...
          <div className="content-section">
            ...
            <div className="content">
              <img src={productMap} alt="product-map" />
            </div>
          </div>
